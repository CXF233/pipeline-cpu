...
#
# Generated by export_simulation on Sun Sep 03 14:44:38 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './data_memory1.sh' script.

./data_memory1.sh -reset_run
...
./data_memory1.sh -noclean_files

For more information on the script, please type './data_memory1.sh -help'.
